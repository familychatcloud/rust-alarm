...
Noler est un réveil ciblé construit avec Rust. Il crée des alarmes uniques et répétitives, prononce à haute voix l'étiquette de chaque alarme et conserve les enregistrements et les paramètres d'alarme sur votre appareil.
...
Rust allie performances natives et sécurité mémoire, avec un même cœur d’application pour iOS et Android. Cela nous aide à garder Noler léger et fiable, sans bibliothèques publicitaires, SDK d’analytique ni services de météo, d’horoscope ou de sommeil. Rust ne prouve pas, à lui seul, une économie de batterie. Notre approche repose sur une implémentation native et l’absence de tâches de fond sans rapport avec le réveil ; les chiffres de consommation doivent être étayés par des mesures sur des appareils réels.

| Ce qui compte | Réveil sans pub ni connexion | Alarmy |
|---|---|---|
...
| **Synchronisation dans le cloud** | Aucun : les données d'alarme restent sur l'appareil | Non comparé ; Noler n'a délibérément pas de couche nuageuse |
...
- Pas de sauvegarde ou de synchronisation cloud
- Pas de service de données d'alarme à distance
- Aucune demande de réseau d'origine croisée en arrière-plan

Les enregistrements d'alarme, les étiquettes, les paramètres, les pièces jointes, la parole et la planification des notifications restent sur votre appareil. Les pages en direct des conditions d'utilisation, de confidentialité et d'assistance ne s'ouvrent que lorsque vous les sélectionnez explicitement dans les paramètres.
...
Sur Android uniquement, le moteur libre Flite intégré fournit une voix anglaise de secours si aucune synthèse vocale système utilisable n’est disponible. Les voix dépendent des langues installées. Le maintien en activité facultatif est désactivé par défaut et peut consommer davantage de batterie.
...
<div align="center">
  ...
  <img src="https://is1-ssl.mzstatic.com/image/thumb/PurpleSource221/v4/ee/7c/35/ee7c357e-20f3-7723-bc78-d904de02817c/Simulator_Screenshot_-_iPhone_17_Pro_Max_-_2026-07-12_at_04.30.29.png/320x480bb.jpg" width="260" alt="Écran des paramètres d'alarme Noler">
</div>

<!-- section:ui-languages -->
## 39 choix de paramètres régionaux d'interface
...
arabe (Égypte), bengali (Bangladesh), néerlandais (Pays-Bas), anglais (Inde), anglais américain, français (France), allemand (Allemagne), hindi (Inde), indonésien (Indonésie), italien (Italie), japonais (Japon), coréen (Corée du Sud), marathi (Inde), polonais (Pologne), portugais brésilien, roumain (Roumanie), russe (Russie), espagnol (États-Unis), tamoul (Inde), télougou (Inde), thaï (Thaïlande), turc (Turquie), ukrainien (Ukraine) et vietnamien (Viêt Nam).
...
Ce dépôt présente le produit ; le code propriétaire de l’application n’y est pas publié. Le moteur vocal Flite intégré est libre.
