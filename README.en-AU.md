<div align="center">
  <p><a href="README.md">English</a> · <strong>English (Australia)</strong> · <a href="LANGUAGES.md">All 39 locales</a></p>

  <img src="https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/ef/7d/df/ef7ddfbd-793f-e33c-ed47-7a23c793eb52/AppIcon-0-0-1x_U007emarketing-0-8-0-85-220.png/512x512bb.jpg" width="150" alt="Free Rust Alarm Clock — No Ads, No Tracking, No Bloat">
...
|---|---|
| iPhone and iPad | [Apple App Store](https://apps.apple.com/us/app/alarm-no-ads-zero-data-usage/id6765933062) |
| Android | [Google Play](https://play.google.com/store/apps/details?id=com.noler.app) |

[Full evidence and Alarmy comparison](README.md) · [Privacy policy](https://noler.com/privacy) · [Support](https://noler.com/support)

---

**This repository is a product-information page, not an open-source distribution. The application source code is proprietary.**

<!-- Locale: en-AU. Generated from scripts/generate-locales.mjs. -->
