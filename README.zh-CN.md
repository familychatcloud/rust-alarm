<div align="center">
  <p><a href="README.md">English</a> · <strong>简体中文</strong> · <a href="README.zh-TW.md">繁體中文</a> · <a href="LANGUAGES.md">全部 39 个语言及地区版本</a></p>
...
| 设备端语音保障 | 系统文字转语音 → 内置离线语音 → 系统闹钟铃声后备 | 以 Alarmy 当前商店说明为准 |
| Rust 构建 | **是**，iOS 与 Android 使用同一套轻量 Rust 应用 | 未公开说明实现技术 |
...
声音保障分为三层：系统文字转语音、内置离线语音后备，以及最后的系统闹钟铃声。目标很简单：语音缺失不能变成静音。
